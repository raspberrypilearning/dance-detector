...
¡Entrena a una computadora para que te ayude a perfeccionar un paso de baile!
...
Puedes [descargar todos los vídeos de este proyecto](https://rpf.io/p/es-LA/dance-detector-go){:target="_blank"}.
...
- Un micro:bit V2
- Un paquete de baterías micro:bit y 2 baterías AAA
- Cable USB
